  ...
  <div class="container">
    <div class="content">
      ...
      <p><strong>Links auf fremde Webseiten</strong>: Inhalte fremder Webseiten, auf die wir direkt oder indirekt
        verweisen, liegen außerhalb unseres Verantwortungsbereiches und machen wir uns nicht zu Eigen. Für alle Inhalte
      ...
      <ul class="m-elements">
        <li><strong>Erhebung von Zugriffsdaten und Logfiles: </strong>Wir selbst (bzw. unser Webhostinganbieter) erheben
          ...
          anderen, um die Auslastung der Server und ihre Stabilität sicherzustellen; <strong>Löschung von
            Daten:</strong> Logfile-Informationen werden für die Dauer von maximal 30 Tagen gespeichert und danach
        ...
        <li><strong>STRATO: </strong>Leistungen auf dem Gebiet der Bereitstellung von informationstechnischer
          Infrastruktur und verbundenen Dienstleistungen (z.B. Speicherplatz und/oder Rechenkapazitäten); <strong>Dienstanbieter:</strong>
          STRATO AG, Pascalstraße 10,10587 Berlin, Deutschland; <strong>Website:</strong> <a
            href="https://www.strato.de"
            target="_blank"
          >https://www.strato.de</a>; <strong>Datenschutzerklärung:</strong>
          <a
            href="https://www.strato.de/datenschutz"
            target="_blank"
          >https://www.strato.de/datenschutz</a>; <strong>Auftragsverarbeitungsvertrag:</strong> mit Anbieter
          abgeschlossen.
        </li>
      </ul>
      ...
      <p class="seal"><a
        ...
        target="_blank"
        rel="noopener noreferrer nofollow"
      >Erstellt mit kostenlosem Datenschutz-Generator.de von Dr. Thomas Schwenke</a></p>ü+ä##
